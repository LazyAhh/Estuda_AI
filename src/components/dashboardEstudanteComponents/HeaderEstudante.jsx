...
export const HeaderEstudante = ({ user, logout }) => {
    return (
            ...
            <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                        Bem-vindo, <strong className="font-semibold text-slate-700">{user?.name_user || user?.nome || "Estudante"}</strong>! Bons estudos!
                    </p>
                </div>
                <button
                    onClick={logout}
...
export default HeaderEstudante;
