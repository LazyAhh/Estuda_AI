...
export const HeaderAdmin = ({ user, logout }) => {
    return (
            ...
            <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1">
                        Olá, <strong className="font-semibold text-slate-700">{user?.name_user || user?.nome || "Admin"}</strong>! Controle de recursos da plataforma.
                    </p>
                </div>
                <button
                    onClick={logout}
